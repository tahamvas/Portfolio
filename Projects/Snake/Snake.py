...
class MAIN:
    ...
    def draw_score(self):
        ...
        bg_rect = pygame.Rect(apple_rect.left, apple_rect.right,
                              apple_rect.width + score_rect.width + 5, apple_rect.height + 8)
...
game_font = pygame.font.Font('Fonts/Lato-Bold.ttf', 25)
